# Wandr — AI Travel Planner (Technical)
...
1. Nav: Compass logo (wandr_logo_new_notext.png) + "Wandr" wordmark + "Curated travel" tagline. Fixed with blur backdrop. Links: Home / Journal / Why Wandr. Hamburger menu on mobile.
...
Nav: Identical to index.html and why.html — compass logo + wordmark + nav links + hamburger on mobile.
...
- Lists all blog posts as cards
- Nav matches production exactly: position fixed, nav.scrolled box-shadow, id="mainNav", scroll listener, hamburger on mobile
- Currently one post: japan-2-week-itinerary.html

### blog/japan-2-week-itinerary.html — Japan itinerary post
- 2-week itinerary: Tokyo (5 days), Hakone (day trip), Osaka (3-4 days), Kyoto (day trips), Nara (half day), Hiroshima (day trip)
- Base: Tokyo (not Osaka)
- Tokyo accommodation tip: stay near JR Yamanote Line (Ginza, Tokyo Station, Shibuya, Shinjuku) — cabs expensive
- Osaka accommodation tip: city centre or Umeda, close to stations
- No em dashes throughout
- Quick-facts grid: repeat(4, 1fr) fixed columns
- Nav matches production exactly
...
- **Logo:** wandr_logo_new_notext.png — compass star mark with calligraphic W (from Adobe Firefly). Used in nav on all pages and as favicon.
- **Nav:** Fixed position across all pages. compass logo (height:40px) + WANDR wordmark (21px Cormorant Garamond, letter-spacing 7px) + "Curated travel" tagline (gold, 8px Jost) + Home / Journal / Why Wandr links. Hamburger menu on mobile (max-width: 768px). nav.scrolled box-shadow on scroll.
...
- Footer subscribe strip on all pages — email field → "You're in. We'll be in touch."
...
- Sending tool: Brevo free tier — to set up when first edition is ready
...
- Blog live at wandrplan.com/blog/ — Japan 2-week itinerary post live
- Hamburger nav added to all pages (mobile)
- Journal nav link added to index.html, planner.html, why.html
...
- More blog posts (Dubai guide, Lisbon/Portugal, Europe itinerary)
